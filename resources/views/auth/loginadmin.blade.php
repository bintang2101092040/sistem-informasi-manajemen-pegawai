...
<body class=" d-flex flex-column">
    ...
    <!-- Libs JS -->
    <!-- Tabler Core -->
    <script src="{{ asset('table/dist/js/tabler.min.js?1692870487') }}" defer></script>
    <script src="{{ asset('table/dist/js/demo.min.js?1692870487') }}" defer></script>
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            const passwordInput = document.querySelector('input[name="password"]');
            const showPasswordButton = document.querySelector('.input-group-text');
