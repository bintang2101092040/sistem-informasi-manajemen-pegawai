<div class="row">
    <div class="col-12" style="text-align: center;">
        ...
        @if (empty($karyawan->foto))
            <img src="{{ asset('assets/img/nophoto.png') }}" alt="" width="150" height="150px">
        @else
            <img src="{{ url($path) }}" alt="" width="170" height="170px">
        @endif
    </div>
</div>
...
<div class="row">
    <div class="col-6">
        ...
        <div class="input-icon mb-3">
            ...
            <input type="text" value="{{ $karyawan->nama_jabatan }}" id="nama_jabatan" name="nama_jabatan"
...
<div class="row">
    <div class="col-6">
        ...
        <div class="input-icon mb-3">
            ...
            <input type="text" value="{{ $karyawan->jenis_kelamin }}" id="jenis_kelamin" name="jenis_kelamin"
                class="form-control" placeholder="Jenis Kelamin" readonly>
        </div>
    </div>
    ...
    <div class="col-6">
        ...
        <div class="input-icon mb-3">
            ...
            <input type="text" value="{{ $karyawan->tempat_tgl_lahir }}" id="tempat_tgl_lahir"
                name="tempat_tgl_lahir" class="form-control" placeholder="Tempat, Tanggal Lahir" readonly>
        </div>
    </div>
</div>
<div class="row">
    <div class="col-6">
        ...
        <div class="input-icon mb-3">
            ...
            <input type="text" value="{{ $karyawan->no_kk }}" id="no_kk" name="no_kk"
                class="form-control" placeholder="NO. KK" readonly>
        </div>
    </div>
    ...
    <div class="col-6">
        ...
        <div class="input-icon mb-3">
            ...
            <input type="text" value="{{ $karyawan->nik_karyawan }}" id="nik_karyawan" name="nik_karyawan"
                class="form-control" placeholder="NIK Karyawan" readonly>
        </div>
    </div>
...
<div class="row">
    <div class="col-6">
        ...
        <div class="input-icon mb-3">
            ...
            <input type="date" value="{{ $karyawan->tanggal_gabung }}" id="tanggal_gabung" name="tanggal_gabung"
                class="form-control" placeholder="Tanggal Gabung" readonly>
        </div>
    </div>
    ...
    <div class="col-6">
        ...
        <div class="input-icon mb-3">
            ...
            <input type="text" value="{{ $karyawan->bpjs_kesehatan }}" id="bpjs_kesehatan" name="bpjs_kesehatan"
                class="form-control" placeholder="BPJS Kesehatan" readonly>
        </div>
    </div>
</div>
<div class="row">
    <div class="col-6">
        ...
        <div class="input-icon mb-3">
            ...
            <input type="text" value="{{ $karyawan->bpjs_ketenagakerjaan }}" id="bpjs_ketenagakerjaan"
                name="bpjs_ketenagakerjaan" class="form-control" placeholder="BPJS Ketenagakerjaan" readonly>
        </div>
    </div>
    ...
    <div class="col-6">
        ...
        <div class="input-icon mb-3">
            ...
            <input type="text" value="{{ $karyawan->rek_mandiri }}" id="rek_mandiri" name="rek_mandiri"
                class="form-control" placeholder="Rek Mandiri" readonly>
        </div>
    </div>
</div>
<div class="row">
    ...
    <div class="col-6">
        ...
        <div class="input-icon mb-3">
            ...
            <input type="text" value="{{ $karyawan->npwp }}" id="npwp" name="npwp" class="form-control"
...
<div class="row">
    <div class="col-6">
        ...
        <div class="input-icon mb-3">
            ...
            <input type="text" value="{{ $karyawan->golongan_darah }}" id="golongan_darah" name="golongan_darah"
                class="form-control" placeholder="Golongan Darah" readonly>
        </div>
    </div>
    <div class="col-6">
        ...
        <div class="input-icon mb-3">
            ...
            <input type="text" value="{{ $karyawan->status }}" id="status" name="status"
                class="form-control" placeholder="Status" readonly>
        </div>
    </div>
</div>
<div class="row">
    <div class="col-12">
        ...
        <div class="input-icon mb-3">
            ...
            <textarea id="data_keluarga" name="data_keluarga" class="form-control" placeholder="Data Keluarga" rows="6"
                readonly>{{ $karyawan->data_keluarga }}</textarea>
        </div>
    </div>
</div>
<div class="row">
    <div class="col-12">
        ...
        <div class="input-icon mb-3">
            ...
            <textarea id="alamat_ktp" name="alamat_ktp" class="form-control" placeholder="Alamat KTP" rows="6" readonly>{{ $karyawan->alamat_ktp }}</textarea>
        </div>
    </div>
</div>
<div class="row">
    <div class="col-12">
        ...
        <div class="input-icon mb-3">
            ...
            <textarea id="alamat_domisili" name="alamat_domisili" class="form-control" placeholder="Alamat Domisili"
                rows="6" readonly>{{ $karyawan->alamat_domisili }}</textarea>
        </div>
    </div>
