                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <a href="#" class="btn btn-primary" id="btnTambahkategori">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="action-column">
                                                        <div class="btn-group">
                                                            ...
                                                            <form action="/kategori/{{ $d->kode_kategori }}/delete"
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="/kategori/store" method="POST" id="formkategori">
                        @csrf
                        <div class="row">
                            <div class="col-12">
                                ...
                                <div class="input-icon mb-3">
                                    ...
                                    <input type="text" value="" id="kode_kategori" name="kode_kategori"
                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                <div class="input-icon mb-3">
                                    ...
                                    <input type="text" value="" id="nama_kategori" name="nama_kategori"
